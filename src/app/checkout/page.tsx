...
function CheckoutContent() {
  ...
  const fetchWebsiteAndPlan = async (
    websiteId: string,
    planId: string
  ) => {
    try {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!agreedToTerms) {
      alert(
        'Please agree to the Terms & Conditions and Privacy Policy before placing your order.'
      )
      return
    }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            companyEventName: e.target.value,
                          }))
                        }
                        className="w-full px-5 py-4 border-2 border-slate-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-900 transition-all duration-300"
                      />
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            requiredLaunchDate: e.target.value,
                          }))
                        }
                        className="w-full px-5 py-4 border-2 border-slate-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-900 transition-all duration-300"
                        required
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 p-6 rounded-2xl">
                      <p className="text-base text-blue-800 font-medium">
                        <strong>Note:</strong> Your order will be created
                        without payment. Payment will be collected later
                    ...
                    <div className="flex gap-4">
                      ...
                      <button
                        ...
                        className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-4 px-6 rounded-2xl font-bold transition-all duration-300 shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {loading
                          ? 'Creating Order...'
                          : 'Create Order'}
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-3xl p-8 shadow-xl border-2 border-slate-200 sticky top-28">
                <h3 className="text-xl font-bold bg-gradient-to-r from-slate-900 to-blue-800 bg-clip-text text-transparent mb-6">
                  Order Summary
                </h3>
