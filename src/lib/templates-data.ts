...
export const DEFAULT_CATEGORIES = [
  ...
  { id: 'cat-college-projects', name: 'Projects for College Students', slug: 'projects-for-college-students', enabled: true },
...
export const DEFAULT_WEBSITES: WebsiteTemplate[] = [
  ...
  {
    id: 'web-scalnex-business-saas',
    name: 'Scalnex — Business Growth & Job SaaS',
    slug: 'scalnex-business-saas',
    category: 'Projects for College Students',
    description: 'Full-stack enterprise AI-powered business scaling and job candidate recommendation platform. Complete with analytics, applicant tracking, and role matching.',
    shortDesc: 'AI-driven business growth and intelligent talent hiring SaaS platform.',
    featured: true,
    published: true,
    startingPrice: 199,
  ...
  },
  {
    ...
    category: 'Projects for College Students',
    description: 'Cybersecurity machine learning engine that parses and detects malicious phishing URLs, email headers, and spoofed domains in real time using NLP & heuristic models.',
    shortDesc: 'Real-time cybersecurity ML engine for detecting phishing URLs and email threats.',
    featured: true,
    published: true,
    startingPrice: 199,
  ...
  },
  {
    ...
    category: 'Projects for College Students',
    description: 'Advanced password entropy analyzer, breach database checker, and AI-assisted credential vulnerability scoring system.',
    shortDesc: 'Entropy calculator and AI credential vulnerability scoring platform.',
    featured: true,
    published: true,
    startingPrice: 199,
  ...
  },
  {
    ...
    category: 'Projects for College Students',
    description: 'Comprehensive online examination and placement readiness assessment portal with proctoring timer, randomized question banks, and instant score analytics.',
    shortDesc: 'Online exam and placement aptitude testing system with instant analytics.',
    featured: true,
    published: true,
    startingPrice: 199,
  ...
  },
  {
    ...
    category: 'Projects for College Students',
    description: 'Interactive intelligent voice agent that performs speech-to-text, natural language command execution, weather lookups, Wikipedia summaries, and audio feedback.',
    shortDesc: 'Voice-controlled desktop & web assistant with NLP intent recognition.',
    featured: true,
    published: true,
    startingPrice: 199,
  ...
  },
  {
    ...
    category: 'Projects for College Students',
    description: 'Cryptographic data hiding tool using Least Significant Bit (LSB) encoding and AES-256 encryption to securely conceal secret payloads within image pixels.',
    shortDesc: 'LSB image steganography and AES-256 encrypted payload concealing application.',
    featured: true,
    published: true,
    startingPrice: 199,
