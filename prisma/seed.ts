...
async function main() {
  ...
  const pricingPlans = [
    { name: '1 Day', durationDays: 1, price: 49, description: 'Perfect for quick celebrations' },
    { name: '3 Days', durationDays: 3, price: 299, description: 'Short events & surprises' },
    { name: '7 Days', durationDays: 7, price: 499, description: 'Most popular', popular: true },
    { name: '15 Days', durationDays: 15, price: 699, description: 'Events & campaigns' },
    { name: '1 Month', durationDays: 30, price: 999, description: 'Startups & projects' },
    { name: '3 Months', durationDays: 90, price: 1999, description: 'Growing businesses' },
    { name: '6 Months', durationDays: 180, price: 3499, description: 'Longer use & branding' },
    { name: '1 Year', durationDays: 365, price: 5999, description: 'Complete online presence' },
  ]
